...
import com.lojaDeGame.repository.GameRepository;
...
public class categoriaController {
	...
	@PostMapping
	public ResponseEntity<categoriaGames> post (@RequestBody categoriaGames games){
		return ResponseEntity.status(HttpStatus.CREATED).body(repository.save(games));
	}
	
	@PutMapping
	public ResponseEntity<categoriaGames> put (@RequestBody categoriaGames games){
