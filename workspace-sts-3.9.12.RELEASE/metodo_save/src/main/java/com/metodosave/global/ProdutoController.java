...
public class ProdutoController {
	...
	public String showNewProdutoPage(Model model) {
		...
		Table_Produto produtoModel = new Table_Produto();
	...
	//Inserir o view na tabela por post
	public String saveProduto(@ModelAttribute("produtoview") Table_Produto produto) {
